...
class TestOptions():
    def __init__(self):
        ...
        self.parser.add_argument('--label_name', type=str, default='../data/style/label/maple.png', help='path of the label image') 
        self.parser.add_argument('--label_nc', type=int, default=128, help='# of input label classes without unknown class.')
        self.parser.add_argument('--style_name', type=str, default='../data/style/label/maple.png', help='path of the style image') 
...
class TrainShapeMatchingOptions():
    def __init__(self):
        ...
        # data loader realted 
        self.parser.add_argument('--style_name', type=str, default='../data/style/style/maple.png', help='path of the style image')   
        self.parser.add_argument('--label_name', type=str, default='../data/style/label/maple.png', help='path of the label image') 
        self.parser.add_argument('--label_nc', type=int, default=128, help='# of input label classes without unknown class.')
        ...
        self.parser.add_argument('--style_number', type=str, default=8, help=' style image number')   
        # ouptput related
        ...
        self.parser.add_argument('--GG_nlayers', type=int, default=3, help='number of layers in structure discriminator G_G')  
        self.parser.add_argument('--GG_nf', type=int, default=32, help='number of features in the first layer of G_G')                     
        self.parser.add_argument('--DG_nlayers', type=int, default=3, help='number of layers in structure discriminator D_G')  
        self.parser.add_argument('--DG_nf', type=int, default=32, help='number of features in the first layer of D_G')
